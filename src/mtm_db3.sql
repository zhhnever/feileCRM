...
CREATE TABLE `tb_agreement`  (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `identification_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `class_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `amount` decimal(65, 0) NULL DEFAULT NULL,
  `discount` int(255) NULL DEFAULT 1 COMMENT '折扣',
  `pdf` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '生成的合同',
...
-- ----------------------------
-- Records of tb_agreement
-- ----------------------------
INSERT INTO `tb_agreement` VALUES (3454312312, 62, 'test', '4350231909870980', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tb_agreement` VALUES (153485517803629, 62, 'test', '432502198910080053', '吉他一对一', 12312, NULL, NULL, 1, NULL, NULL);
INSERT INTO `tb_agreement` VALUES (153485574040813, 65, 'xhy1', '432502198910080053', '吉他一对一', 123432, 1, NULL, 0, NULL, NULL);
INSERT INTO `tb_agreement` VALUES (153485586252543, 62, 'test', '432502198910080053', '钢琴教学一对一', 12345, 1, NULL, 0, NULL, NULL);
...
-- ----------------------------
-- Table structure for tb_cc_assign
-- ----------------------------
DROP TABLE IF EXISTS `tb_cc_assign`;
CREATE TABLE `tb_cc_assign`  (
  `id` int(11) NOT NULL,
  `cc_id` int(11) NOT NULL COMMENT 'ccID',
  `state` int(11) NULL DEFAULT NULL COMMENT '状态1:繁忙;2:空闲;3:休假;4:其他;',
  `creater_id` int(11) NULL DEFAULT NULL COMMENT '操作员',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Records of tb_cc_assign
-- ----------------------------
INSERT INTO `tb_cc_assign` VALUES (2, 2, 0, 1, '2018-08-12 15:08:52', '2018-08-12 15:08:55');
INSERT INTO `tb_cc_assign` VALUES (3, 2, 1, 1, '2018-08-12 15:46:10', '2018-08-12 15:46:13');
INSERT INTO `tb_cc_assign` VALUES (343156491, 2, 0, NULL, '2018-08-13 21:09:09', '2018-08-13 21:14:57');
INSERT INTO `tb_cc_assign` VALUES (378348315, 3, 0, NULL, '2018-08-13 21:15:01', '2018-08-13 21:15:19');
INSERT INTO `tb_cc_assign` VALUES (463083321, 3, 1, NULL, '2018-08-12 21:37:29', '2018-08-12 21:37:29');
INSERT INTO `tb_cc_assign` VALUES (479272618, 4, 1, NULL, '2018-08-12 21:40:11', '2018-08-12 21:40:11');
...
INSERT INTO `tb_member` VALUES (66, '432412', NULL, '123435345', '男', '高中/中专学校', NULL, 1, NULL, '大众点评', '0', 0.00, NULL, '2018-07-30 21:57:37', '2018-07-30 21:57:37');
INSERT INTO `tb_member` VALUES (67, '阿斯达斯', NULL, '4235343412312', '男', '硕士研究院', NULL, 1, NULL, '派发菲乐宣传单页', '0', 0.00, NULL, '2018-07-30 21:59:31', '2018-07-30 21:59:31');
...
-- ----------------------------
-- Records of tb_member_question
-- ----------------------------
INSERT INTO `tb_member_question` VALUES (1, 66, '26-30岁', NULL, '上班族', '弹钢琴让我心情愉悦，又锻炼了左右大脑，一定可以长命百岁！', '1打算', NULL, '2018-07-30 21:57:37', '2018-07-30 21:57:37');
INSERT INTO `tb_member_question` VALUES (2, 67, '31-35岁', NULL, '管理层', '学会钢琴，不但增强了自己在异性面前的魅力，以后还可以自己教孩子！', 'dasd as', NULL, '2018-07-30 21:59:31', '2018-07-30 21:59:31');
...
CREATE TABLE `tb_panel`  (
  ...
  INDEX `sort_order`(`sort_order`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '内容分类' ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_panel` VALUES (11, '资讯', 1, 1, 0, 999, 1, '', '2018-08-12 13:01:07', '2018-08-12 13:01:07');
...
INSERT INTO `tb_panel_content` VALUES (52, 7, 1, NULL, 0, 'http://www.fwpiano.com', 'c4cf97bfc57b47c48e691169650fd105.jpg', '', '', '2018-08-12 13:19:12', '2018-08-12 13:19:12');
INSERT INTO `tb_panel_content` VALUES (53, 7, 1, NULL, 1, 'www.fwpiano.com', '8acc25f4a64d43ebbd8e2464145666f5.jpg', '', '', '2018-08-12 13:27:04', '2018-08-12 13:27:04');
INSERT INTO `tb_panel_content` VALUES (54, 7, 1, NULL, 2, 'www.fwpiano.com', 'b76bc2623845419991bd155ecb9f45a2.jpg', '', '', '2018-08-12 13:28:42', '2018-08-12 13:28:42');
...
INSERT INTO `tb_permission` VALUES (68, '网站内容管理', '/content/*');
...
CREATE TABLE `tb_receipt`  (
  ...
  `receipt_date` datetime(0) NULL DEFAULT NULL COMMENT '付款时间',
  `m_id` int(11) NULL DEFAULT NULL COMMENT '会员id',
  `a_id` bigint(20) NULL DEFAULT NULL COMMENT '合同id',
  `u_id` int(11) NULL DEFAULT NULL COMMENT '收款人id',
  `amount` decimal(60, 0) NULL DEFAULT NULL COMMENT '金额',
  `payment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '付款方式',
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '收据类型',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_role` VALUES (2, '客服', '可以分配CC');
INSERT INTO `tb_role` VALUES (3, '老师', '老师');
INSERT INTO `tb_role` VALUES (4, '网站内容管理员', '网站内容管理,发布新闻,更改banner,');
INSERT INTO `tb_role` VALUES (5, 'CC', 'CC接待');
...
INSERT INTO `tb_role_perm` VALUES (188, 4, 68);
...
INSERT INTO `tb_user` VALUES (2, '测试账号', '098f6bcd4621d373cade4e832627b4f6', '12345678901', '123@qq.com', '女', NULL, 1, '游客', 5, 'http://www.fwpiano.com/images/charlie.jpg', '2017-09-05 21:27:54', '2018-08-12 15:21:22');
INSERT INTO `tb_user` VALUES (3, '测试CC1', 'e10adc3949ba59abbe56e057f20f883e', '123214324', '232430773@qq.com', '男', NULL, 1, '', 5, 'http://www.fwpiano.com/images/han.jpg', '2018-08-12 16:20:41', '2018-08-12 16:20:41');
INSERT INTO `tb_user` VALUES (4, '测试CC2', 'e10adc3949ba59abbe56e057f20f883e', '4355090', '23@qq.com', '男', NULL, 1, 'CC', 5, 'http://www.fwpiano.com/images/yi.jpg', '2018-08-12 16:21:06', '2018-08-12 16:21:06');
