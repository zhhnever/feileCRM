package com.blacksheep.mtm.swagger;
...
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                //扫描指定包中的swagger注解
                //.apis(RequestHandlerSelectors.basePackage("cn.  Z.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .termsOfServiceUrl("http://blog.  Z.cn")
                .contact(new Contact("  Z", "http://blog.  Z.cn", "232430773@qq.com"))
                .version("1.0.0")
                .build();
    }
}
