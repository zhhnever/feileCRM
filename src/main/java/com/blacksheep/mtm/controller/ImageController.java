...
import com.blacksheep.mtm.pojo.common.KindEditorResult;
...
public class ImageController {
    ...
    public Result<Object> uploadFile(@RequestParam("file") MultipartFile files,
        ...
        // 文件保存路径
        String imageName= QiniuUtil.renamePic(files.getOriginalFilename());
...
//            }
        ...
        return new ResultUtil<Object>().setData(imageName);
    }
...
//            }
            ...
            kindEditorResult.setUrl(imageName);
            return kindEditorResult;
        } catch (IOException e) {
            e.printStackTrace();
        }
