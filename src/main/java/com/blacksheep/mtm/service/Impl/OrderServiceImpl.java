...
import com.blacksheep.mtm.dao.TbOrderMapper;
import com.blacksheep.mtm.dao.TbOrderShippingMapper;
import com.blacksheep.mtm.dao.TbThanksMapper;
...
public class OrderServiceImpl implements OrderService {
    ...
    public int passPay(String tokenName, String token, String id) {
        ...
        if(StringUtils.isNotBlank(tbThanks.getEmail())&& emailUtil.checkEmail(tbThanks.getEmail())){
            String content="您的订单已支付成功，十分感谢您的捐赠！<br>您可以在捐赠名单中查看到您的数据：" +
                    "<a href='http://xmall.  Z.cn/#/thanks'>http://xmall.  Z.cn/#/thanks</a><br>Powered By XPay.   Z Present.";
    ...
    public int backPay(String tokenName, String token, String id) {
        ...
        //发送通知邮箱
        if(StringUtils.isNotBlank(tbThanks.getEmail())&& emailUtil.checkEmail(tbThanks.getEmail())){
            String content="抱歉，由于您支付不起或其他原因，您的订单支付失败，请尝试重新支付！<br>Powered By XPay.   Z Present.";
