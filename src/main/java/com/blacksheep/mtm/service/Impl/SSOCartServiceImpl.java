...
import com.blacksheep.mtm.service.SSOCartService;
...
@Service
public class SSOCartServiceImpl implements SSOCartService {

    private final static Logger log= LoggerFactory.getLogger(SSOCartServiceImpl.class);
