...
import com.blacksheep.mtm.service.SSOOrderService;
...
public class SSOOrderServiceImpl implements SSOOrderService {
    ...
    @Autowired
    private SSOEmailUtil SSOEmailUtil;
    ...
    public int payOrder(TbThanks tbThanks) {
        ...
        SSOEmailUtil.sendEmailDealThank(EMAIL_SENDER,"【XMall商城】支付待审核处理",tokenName,token,tbThanks);
        return 1;
    }
