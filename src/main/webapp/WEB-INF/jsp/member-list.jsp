...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            ...
            <a href="javascript:;" onclick="member_add('添加用户','member-add','','630')" class="btn btn-primary radius"><i
...
<script type="text/javascript">
    ...
    var Id = "", username = "", phone = "", email = "", education = "", sex = "", channel = "", created = "",
        balance = "", points = "", file = "";
    ...
    function member_fllow(username,id,url) {
        var title = username + "--跟进详情";
        Id = id;
    ...
    function member_show(title, url, w, h) {
        ...
        $('.table tbody').on('click', 'tr', function () {
            ...
            education = table.row(this).data().education;
            sex = table.row(this).data().sex;
            channel = table.row(this).data().channel;
