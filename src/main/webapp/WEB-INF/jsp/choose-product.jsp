            ...
            "columns": [
                ...
                { "data": "image",
                    render: function(data, type, row, meta) {
                        return '<img src="'+imageShow('upload/'+data)+'" style="width: 80px;height: 60px" alt="" />';
                    }
                },
                { "data": "title",
                    render: function(data, type, row, meta) {
                ...
                },
                {
                    "data": null,
                    render: function (data, type, row, meta) {
                        return "<input onclick='chooseProduct()' class='btn btn-danger-outline size-S radius' type='button' value='选择该课程'>";
                    }
                }
            ],
