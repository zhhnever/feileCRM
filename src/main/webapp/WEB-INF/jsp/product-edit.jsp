...
<div class="page-container">
    <form name="product-add" action="" method="post" class="form form-horizontal" id="product-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>课程时长：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="classTime" id="classTime" placeholder="0~999" value="" class="input-text" style="width:50%">
                分钟</div>
        </div>
        <div class="row cl">
    ...
    KindEditor.ready(function(K) {
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $("#classTime").val(data.result.classTime);
