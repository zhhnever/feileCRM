...
<head>
    ...
    <![endif]-->
    <title>菲乐CRM系统 v1.1</title>
</head>
<body>
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/">菲乐CRM系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/">MTM后台管理系统</a>
                ...
                <ul class="cl">
                    <li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="javascript:;" onclick="product_add('添加课程','product-add')"><i class="Hui-iconfont">&#xe620;</i> 课程</a></li>
                        ...
                        <%--<li ><a href="http://xpay.  Z.cn" target="_blank">XPay支付系统</a></li>--%>
                        <%--<li ><a href="http://MTMall.  Z.cn" target="_blank">商城前台</a></li>--%>
                    </li>
                </ul>
            </nav>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            <dt><i class="Hui-iconfont">&#xe616;</i> 网站内容管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
        ...
        <dl id="menu-comments">
            <dt><i class="Hui-iconfont">&#xe622;</i> 合同收据<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="agreement-list" data-title="合同管理" href="javascript:void(0)">合同管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="member-fllow-list" data-title="会员跟进列表" href="javascript:;">会员跟进列表</a></li>
        ...
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    <li><a data-href="admin-list" data-title="员工列表" href="javascript:void(0)">员工列表</a></li>
