...
<div class="page-container">
    <%=htmlData%>
    <form name="news-add" action="" method="post" class="form form-horizontal" id="news-add">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="text" onclick="chooseCategory()" readonly class="input-text" value=""
                       placeholder="请点击选择按钮选择新闻类型" id="catTitle" name="catTitle" style="width:50%">
                <input type="button" onclick="chooseCategory()" class="btn btn-secondary radius" value="选择新闻类型">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>选择作者：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" hidden class="input-text" id="tid" name="authorId">
                <input type="text" onclick="chooseTeacher()" readonly class="input-text" value=""
                       placeholder="请点击选择按钮选择作者" id="teacher" name="teacher" style="width:50%">
                <input type="button" onclick="chooseTeacher()" class="btn btn-secondary radius" value="选择作者">
            </div>
        </div>
        <input type="text" name="pic" id="pic" hidden/>
        <div class="row cl">
...
<script type="text/javascript">
    ...
    function chooseCategory() {
        layer_show("选择新闻种类", "choose-news-cat", 900, 600);
    }

    function chooseTeacher() {
        layer_show("选择作者", "choose-teacher", 900, 600)
    }
        ...
        editor = K.create('textarea[name="detail"]', {
            ...
            afterCreate: function () {
                ...
                K.ctrl(document, 13, function () {
                    self.sync();
                    document.forms['news-add'].submit();
                });
    ...
    (function ($) {
        ...
        $(function () {
            ...
            uploader = WebUploader.create({
                ...
                fileNumLimit: 1,
                fileSizeLimit: 1 * 1024 * 1024,    // 25 M
                fileSingleSizeLimit: 1 * 1024 * 1024    // 5 M
            });
