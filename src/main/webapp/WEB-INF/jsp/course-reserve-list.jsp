...
<body class="pos-r">
<div style="">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 课程排期管理 <span class="c-gray en">&gt;</span> 学生预约列表 <span class="c-gray en">&gt;</span><span id="category">所有学生</span> <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <form id="form-search" class="page-container">
        <div class="text-c"> 日期范围：
            ...
            <input type="text" name="searchKey" id="searchKey" placeholder=" 学生、老师" style="width:250px" class="input-text">
...
//    }
    ...
    $("#form-search").validate({
        ...
        submitHandler:function(form){
            ...
            table.ajax.url( './reserve/listSearch' ).load();
        }
    });
...
//    });
    ...
    function product_stop(obj,id){
        layer.confirm('确认要取消ID为\''+id+'\'的预约吗？',{icon:0},function(index){
            var index = layer.load(3);
            $.ajax({
                type: 'PUT',
                url: './course/stop/'+id,
